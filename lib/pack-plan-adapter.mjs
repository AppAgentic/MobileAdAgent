...
const RESEARCH_TIMEOUT_MS = 28_000;
const MAX_SIGNALS = 8;
...
2. Prefer the app's own public store-review pages, official pages, relevant public community discussions, and up to three close competitor listing/review pages.
